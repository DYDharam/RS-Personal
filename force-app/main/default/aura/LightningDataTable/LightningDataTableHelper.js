({
    getRecords : function(component, event, helper, sObjectName) {
    ...
    getTotalNumberOfSobject : function(component, sObjectName) {
        var action = component.get("c.getTotalSobjectRecords");
        action.setParams({
        		sObjectName : sObjectName
        	});
        action.setCallback(this, function(response) {
    ...
    getColumnAndAction : function(component) {
        var actions = [
            {label: 'New', name: 'new', disabled: { fieldName: 'Active_Customer__c'}},
    ...
    getMoreSobjectRecords: function(component , rows, sObjectName){
